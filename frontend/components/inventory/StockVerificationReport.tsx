    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Stock Verification Report</h1>
            <p className="text-sm text-gray-500">Verify physical stock against system records</p>
          </div>
        </div>
        {!showForm ? (
          <Button
